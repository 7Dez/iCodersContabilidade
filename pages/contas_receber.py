...
def contas_receber_view(page: ft.Page):
    ...
    def adicionar_conta(e):
        ...
        print("Nova conta a receber:", nova_conta)
        page.snack_bar = ft.SnackBar(ft.Text("Conta a receber adicionada com sucesso!"))
        page.snack_bar.open = True
        page.update()
    ...
    page.add(
        ft.Column(
            [
                ft.Text("Contas a Receber", size=30, weight=ft.FontWeight.BOLD),
